...
function hesk_iFinish() {
    ...
    Password: <b>admin</b>
            ...
            <form action="<?php echo HESK_PATH; ?>admin/index.php" method="post">
                ...
                <input type="submit" value="Click here to login automatically &raquo;" class="orangebutton" onmouseover="hb_btn(this, 'orangebuttonover');" onmouseout="hb_btn(this, 'orangebutton');" /></p>
            </form>
...
");
    ...
    hesk_dbQuery("INSERT INTO `" . hesk_dbEscape($hesk_settings['db_pfix']) . "users` (`id`, `user`, `pass`, `isadmin`, `name`, `email`, `signature`, `heskprivileges`) VALUES (1, 'Administrator', '499d74967b28a841c98bb4baaabaad699ff3c079', '1', 'Your name', 'you@me.com', 'Sincerely,\r\n\r\nYour name\r\nYour website\r\nhttp://www.yourwebsite.com', '')");
